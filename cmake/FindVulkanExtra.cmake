...
if(Vulkan_FOUND)
  message(WARNING "Vulkan found:")
  message(WARNING "  Version                   : ${Vulkan_VERSION}")
  message(WARNING "  Include Directory         : ${Vulkan_INCLUDE_DIRS}")
  message(WARNING "  Library Directory         : ${Vulkan_LIBRARY}")
  message(WARNING "  GLSLANG Validator         : ${Vulkan_GLSLANG_VALIDATOR_EXECUTABLE}")
  message(WARNING "  ShaderC Import Library    : ${Vulkan_SHADERC_SHARED_LIBRARY}")
  message(WARNING "  ShaderC Shared Library    : ${Vulkan_SHADERC_SHARED_DLL}")
  message(WARNING "  SPIRV-Tools Import Library: ${Vulkan_SPIRV_TOOLS_SHARED_LIBRARY}")
  message(WARNING "  SPIRV-Tools Shared Library: ${Vulkan_SPIRV_TOOLS_SHARED_DLL}")
  if(Vulkan_VOLK_DIR)
    message(WARNING "  Volk Directory        : ${Vulkan_VOLK_DIR}")
  else()
    message(WARNING "  Volk Directory        : Using fallback")
  endif()
else()
